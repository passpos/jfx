 ...
 */
public class AreaChartApp extends ContentBox {

    public final static boolean SHOWING = false;
    public final static String TITLE = "Chart - AreaChart/区域图";
    ...
    public void baseDemo() {
        ...
        AreaChart<String, Number> ac = new AreaChart<>(x, y);
        ac.getData().addAll(xy1, xy2);
        ac.setTitle("AreaChart");
        // 是否创建折点
