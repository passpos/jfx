 ...
 */
public class ScatterChartApp extends ContentBox {

    public final static boolean SHOWING = false;
    public final static String TITLE = "Chart - ScatterChart/散点图";
    ...
    public void baseDemo() {
        ...
        ScatterChart<String, Number> sbc = new ScatterChart<>(x, y);
        sbc.getData().addAll(xy1, xy2);
        sbc.setTitle("ScatterChart");
        getChildren().add(sbc);
